...
export default function Wallet() {
  ...
  const debtBalance = company?.debtBalance || 2500;
  ...
  return (
    <>
      <Header 
        title="DEBT Wallet" 
        subtitle="Manage your DEBT tokens and view transaction history" 
      />
                ...
                <div className="mt-6 p-4 bg-primary bg-opacity-5 rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{stats?.activeLoops || 0}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Settlements participated</span>
                      <span className="font-medium">{allLoops.filter((l: any) => l.status === "completed").length}</span>
                    </div>
                    <div className="flex justify-between">
